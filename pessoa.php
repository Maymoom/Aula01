            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="https://localhost/QTS-main/">Início</a></li>
                        <li class="breadcrumb-item"><a href="https://localhost/QTS-main/listapessoa">Listagem</a></li>
                                ...
                                <div class="card card-primary">
                                    ...
                                    <form name="form" method="post" id="form">
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <button id="btnreset" name="btnreset" type="reset" class="btn btn-primary" value="Reset">Limpar <i class="fas fa-save"></i> </button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->
